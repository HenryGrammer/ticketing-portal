...
<div class="row">
    <div class="col-lg-6">
        ...
        <input type="tel" name="viber_number" class="form-control input-sm" placeholder="Ex: +639123456789">
    ...
    <div class="col-lg-12">
        ...
        <textarea name="task" class="form-control input-sm" cols="30" rows="10"></textarea>
        <div class="invalid-feedback"></div>
    </div>
    <div class="col-lg-12">
        Attachment :
